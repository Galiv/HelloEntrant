...
namespace ApplicationTest.AdministratorTests
{
    public class GetRatingAsyncTests
    {
        ...
        public async void GetRatingAsync_ShouldReturnValidValues()
        {
            ...
            mockUnitOfWork.Setup(a => a.ApplicationRepository.GetAllApplicationsOfSpeciality(1)).ReturnsAsync(applications);
        ...
        public async void GetRatingAsync_ShouldReturnValidAverageMark()
        {
            //arrange
            ...
            //assert
            Assert.True(result[0].AverageMark == 140);
